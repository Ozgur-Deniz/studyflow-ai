...
export function QuickActionsGrid({
  ...
  return (
    <div>
      <h2
        className={`mb-4 flex items-center gap-2 text-base font-bold text-[#0f172a] transition-[opacity,transform] duration-[520ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:text-[18px] ${
        ...
        {quickActions.map((action, index) => {
          ...
          return (
            <Link
              key={action.title}
              href={action.href}
              className={`group relative flex min-h-[170px] flex-col overflow-hidden rounded-2xl border border-[#e2e8f0] bg-white p-4 text-left card-hover transition-[opacity,transform,border-color,box-shadow] duration-[560ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-[#cbd5e1] sm:min-h-[190px] sm:p-5 ${
                shouldShow
            ...
            >
              ...
              <div className="relative flex h-full flex-col">
                ...
                <div className="mt-auto pt-5 flex items-end justify-between gap-3">
                  ...
                  <span className={`text-2xl font-black leading-none md:text-3xl ${action.color}`}>
